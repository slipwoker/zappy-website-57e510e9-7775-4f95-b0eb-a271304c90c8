    ...
    fields.forEach(function (field) {
      ...
      if (pattern) {
        ...
        if (!patternRegex.test(value)) {
          showFieldError(field, field.getAttribute('title') || getErrorMessage('pattern', name));
          isValid = false;
          if (!firstInvalidField) firstInvalidField = field;
        }
      }
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '57e510e9-7775-4f95-b0eb-a271304c90c8',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '57e510e9-7775-4f95-b0eb-a271304c90c8';
            ...
            if (mobileToggle && navMenu) {
                ...
                if (phoneHeaderBtn) {
                    phoneHeaderBtn.addEventListener('click', function() {
                        ...
                        // Falls back to 052-2848831 placeholder which businessInfoUpdater can replace
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '57e510e9-7775-4f95-b0eb-a271304c90c8';
